...
"""
        ...
        for chunk_index, chunk in enumerate(
            ...
            if chunk_index > max_stream_chunks:
                logger.error("Reached max stream chunk count without generating an image artifact")
                break
        ...
        logger.error("No image artifact was generated by the model stream.")
        return (
            "No improved landing page image was generated in this attempt. "
            "Please verify the prompt, API access, and model availability, then try again."
        )
